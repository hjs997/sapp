...
// 环境变量
const UUID = process.env.UUID || 'cbb46739-6231-4a44-a176-e615d1f9d390'; // 使用哪吒v1，在不同的平台部署需修改UUID，否则会覆盖
const NEZHA_SERVER = process.env.NEZHA_SERVER || 'sui.txxk.xyz';       // 哪吒v1填写形式：nz.abc.com:8008   哪吒v0填写形式：nz.abc.com
const NEZHA_PORT = process.env.NEZHA_PORT || '443';           // 哪吒v1没有此变量，v0的agent端口为{443,8443,2096,2087,2083,2053}其中之一时开启tls
const NEZHA_KEY = process.env.NEZHA_KEY || 'POUwNlFxp2WQ7OMUhg';             // v1的NZ_CLIENT_SECRET或v0的agent端口  
...
const SUB_PATH = process.env.SUB_PATH || 'log';            // 节点订阅路径
